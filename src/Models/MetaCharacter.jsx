...
Command: npx gltfjsx@6.2.16 .\public\models\6620bfdd86f86e3a6c44068f.glb 
*/
"use client";
import React, { useEffect, useRef } from "react";
import { useAnimations, useFBX, useGLTF } from "@react-three/drei";

export default function MetaCharacter(props) {
  const group = useRef();
  const { nodes, materials } = useGLTF("models/Divya.glb");
  const { animations: wavingAnimation } = useFBX("animations/Waving.fbx");
  wavingAnimation[0].name = "Waving";
  const { actions } = useAnimations([wavingAnimation[0]], group);
  useEffect(() => {
